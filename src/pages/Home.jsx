...
export default function Home() {
  return <><HeroSlider /><FeaturedCategories /><FavouriteReels />
    ...
    <ImageBanner images={[brandAssets.middleBanner1]} className="middle-banner" />
    <ProductSection eyebrow="Just Arrived" title="New Arrivals" products={products.slice(2, 6)} variant="arrival" />
    <ImageBanner images={[brandAssets.middleBanner2]} className="middle-banner" /><BenefitsStrip /><Testimonials /><SocialMarquee /><VideoSection /></>;
}
