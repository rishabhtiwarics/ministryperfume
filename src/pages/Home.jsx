...
export default function Home() {
  return <><HeroSlider /><FeaturedCategories /><FavouriteReels />
    <ProductSection eyebrow="Customer Choice" title="Best Seller" products={products.slice(1, 5)} variant="seller" bottomAction />
    <ImageBanner images={[brandAssets.middleBanner1]} mobileImages={[brandAssets.mobileMiddleBanner1]} className="middle-banner" />
    <ProductSection eyebrow="Just Arrived" title="New Arrivals" products={products.slice(2, 6)} variant="arrival" />
    <ImageBanner images={[brandAssets.middleBanner2]} mobileImages={[brandAssets.mobileMiddleBanner2]} className="middle-banner" /><BenefitsStrip /><Testimonials /><SocialMarquee /><VideoSection /></>;
}
